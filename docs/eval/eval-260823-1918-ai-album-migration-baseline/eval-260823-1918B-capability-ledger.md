...
| Privacy classification | Local NudeNet/NSFW result affected routing | `precheck` and `plan` | Preserve local evidence; Agent/user policy controls interpretation | Recall, false positives, data-egress enforcement |
