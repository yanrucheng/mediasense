...
2. Plan does not replace PreCheck's source facts, candidate evidence, coverage, or declared omissions. It may interpret, ignore, challenge, request replacement, or add a separately owned observation through an authorization-bound stage-neutral capability.
