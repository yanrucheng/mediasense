---
id: "default-organization-profile"
...
Language choice and translation belong to Plan's naming judgment under the Human's language preference. Original place text and provider candidates remain source evidence; a translated or normalized display name must not replace them as observations. No per-item translation cache or mandatory translation Tool is required. When translation is uncertain, preserve a recognizable original name or expose the uncertainty rather than inventing a venue. This intentionally replaces AI Album's optional standalone translation generator while retaining its useful language-transformation purpose.
