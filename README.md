...
The `0.3.0` distribution provides the installed `mediasense` executable, portable-
...
contains the certified Codex-local Skill and MCP configuration, while installing
the executable does not edit any Agent client's configuration or enable external
